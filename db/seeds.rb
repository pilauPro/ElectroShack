c1 = Customer.create(first_name: 'Matt', last_name: 'Leininger', user_name: 'mmleinin', password: 'ozzy', email: 'leiningem001@hawaii.rr.com')
c2 = Customer.create(first_name: 'Heather', last_name: 'Eicher', user_name: 'heicher', password: 'happy', email: 'heicher79@yahoo.com')
